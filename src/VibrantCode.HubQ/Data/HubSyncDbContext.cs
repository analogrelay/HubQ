...
namespace VibrantCode.HubQ.Data
{
    ...
    {
        public static readonly string LocalConnectionString = @"Server=(localdb)\MSSQLLocalDB;Database=HubSync;Trusted_Connection=True;MultipleActiveResultSets=true";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                actor.HasIndex(a => a.GitHubId);
                actor.Property(a => a.Name).IsRequired();

                actor.Property(a => a.Kind).HasConversion(new EnumToStringConverter<ActorKind>());
